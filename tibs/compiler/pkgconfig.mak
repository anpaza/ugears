...
define BUILD.PKGCONFIG
	sed -e "s,@DESTDIR@,$(DESTDIR),g" \
	    -e "s,@CONF_PACKAGE@,$(CONF_PACKAGE),g" \
...
ifdef DETECT_SYSLIB
define _DETECT_SYSLIBS
$(if $(subst /2/,,/$(words $(subst =,$(SPACE),$1))/),\
$(error DETECT_SYSLIBS must contain pairs like SYSLIB=syslib),\
$(call DETECT_SYSLIB,$(word 1,$(subst =,$(SPACE),$1)),$(word 2,$(subst =,$(SPACE),$1)))\
)
endef

$(eval $(foreach 1,$(DETECT_SYSLIBS),$(call _DETECT_SYSLIBS,$1)))
endif
