...
define COMPILE.MSVC.CXX
	$(MSVC.CXX) -Fo$@ $(strip $(MSVC.CXXFLAGS) $1) $<
	$(MSVC.MDEP) $(strip $(MSVC.MDEPFLAGS) $(filter -D%,$1) $(filter -I%,$1)) -f $(@:.obj=.d) $<
endef
define COMPILE.MSVC.CC
	$(MSVC.CC) -Fo$@ $(strip $(MSVC.CFLAGS) $1) $<
	$(MSVC.MDEP) $(strip $(MSVC.MDEPFLAGS) $(filter -D%,$1) $(filter -I%,$1)) -f $(@:.obj=.d) $<
endef
